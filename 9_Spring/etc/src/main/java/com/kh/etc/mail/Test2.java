...
public class Test2 {
	...
	public String mail() {
		...
		String[] to = {"tjwodyd3215@gmail.com"};
		message.setTo(to);
	...
	public String hypermail() throws MessagingException {
		...
		// uuid(겹치지않는 고유한 코드), 이메일, 시간을 데이터베이스에 기록
		// jj131315212 / tjwodyd3215@gmail.com / 2024/11/11 12:44
		
		String url = ServletUriComponentsBuilder
				.fromCurrentContextPath()
				.port(7777).path("/changePassword")
				.queryParam("user_id", "tjwodyd3215")
	...
	public String sendFile() throws MessagingException {
		...
		// 첨부파일 추가
		DataSource source = new FileDataSource("C:\\Users\\user1\\Desktop\\3b579a9bc531180d72a68a9686c6da3b.jpg"); 
