...
public class Member {
	...
	public Member(int user_No, String userId, String userPwd, String userName, String phone, String email,
	...
	public String toString() {
		return "Member [user_No=" + user_No + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
