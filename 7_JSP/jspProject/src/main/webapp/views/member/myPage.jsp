            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <label>
                            <input type="checkbox" name="interest" id="sports" value="등산">
                            등산
                        </label>
                        <label>
                            <input type="checkbox" name="interest" id="sports" value="낚시">
                            낚시
                        </label>
                        <br>
                        <label>
                            <input type="checkbox" name="interest" id="sports" value="요리">
                            요리
                        </label>
                        <label>
                            <input type="checkbox" name="interest" id="sports" value="게임">
                            게임
                        </label>
                        <label>
                            <input type="checkbox" name="interest" id="sports" value="영화">
                            영화
                        </label>
                        <label>
                            <input type="checkbox" name="interest" id="sports" value="기타">
                            기타
                        </label>
                    </td>
                </tr>
