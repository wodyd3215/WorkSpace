...
<body>
	...
	<p>
		...
		(fmt:formatNumber value="출력할값" [groupingUsed="true(기본값) | false" type="percent | currency" currencySymbol="문자"])
	</p>
	...
	percent : <fmt:formatNumber value="${num3}" type="currency" groupingUsed="false"/><br>
	percent : <fmt:formatNumber value="${num3}" type="currency" groupingUsed="false" currencySymbol="$"/><br>
	
	<h3>2. formatDate</h3>
	<p>날짜 및 시간데이터의 포맷 지정(단, java.util.Date객체 사용)</p>
	...
	<ul>
		<li>현재 날짜 : <fmt:formatDate value="${current}" type="date"/></li> <!-- type생략시 type="date"(기본값) -->
